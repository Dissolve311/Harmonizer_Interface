...
//        else
        ...
        this.module = {
            ...
            properties:{
                width:              {type:Number, value:1500, observer:'layout'},
                height:             {type:Number, value:360, observer:'layout'},
                timebase:           {type:Number, value:32, observer:'layout'},
                editmode:           {type:String, value:"dragpoly"},
                xrange:             {type:Number, value:64, observer:'layout'},
                yrange:             {type:Number, value:20, observer:'layout'},
                ...
                xruler:             {type:Number, value:22, observer:'layout'},
                yruler:             {type:Number, value:22, observer:'layout'},
                ...
                collt:              {type:String, value:"rgba(128, 128, 128, 0.5)"},
                coldk:              {type:String, value:"rgba(0, 128, 0, 0.5)"},
                colgrid:            {type:String, value:"#666"},
                colnote:            {type:String, value:"#ABCDEF"},
                colnotesel:         {type:String, value:"#5a00aa"},
                colnoteborder:      {type:String, value:"#000"},
                colnoteselborder:   {type:String, value:"#fff"},
                colrulerbg:         {type:String, value:"transparent"},
                colrulerfg:         {type:String, value:"#fff"},
                colrulerborder:     {type:String, value:"rgba(56, 128, 56, 0.5)"},
                colselarea:         {type:String, value:"rgba(0,0,0,0.3)"},
                bgsrc:              {type:String, value:null, observer:'layout'},
                cursorsrc:          {type:String, value:"data:image/svg+xml;base64,"},
                cursoroffset:       {type:Number, value:0},
                markstartsrc:       {type:String, value:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjQiIGhlaWdodD0iMjQiIHZpZXdCb3g9IjAgMCAyNCAyNCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4NCjxwYXRoIGQ9Ik0wIDFIMjRMMCAyM1YxWiIgZmlsbD0iIzc5MEZFMyIvPg0KPC9zdmc+DQo="},
                markstartoffset:    {type:Number, value:0},
                markendsrc:         {type:String, value:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjQiIGhlaWdodD0iMjQiIHZpZXdCb3g9IjAgMCAyNCAyNCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4NCjxwYXRoIGQ9Ik0wIDFIMjRWMjNMMCAxWiIgZmlsbD0iIzc5MEZFMyIvPg0KPC9zdmc+"},
                markendoffset:      {type:Number, value:-24},
                kbsrc:              {type:String, value:"data:image/svg+xml;base64,", observer:'layout'},
